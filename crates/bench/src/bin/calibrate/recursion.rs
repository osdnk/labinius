...
pub fn the_encoding_at_the_basic_parameters() {
...
pub fn run(which: Option<&str>) {
    match which {
        Some("the_encoding_at_the_basic_parameters") => the_encoding_at_the_basic_parameters(),
        None => {
            the_encoding_at_the_basic_parameters();
        }
